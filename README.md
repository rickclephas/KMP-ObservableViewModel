...
|---------------|---------------------|:---------:|:----------:|:------------------:|
| **_latest_**  | **_no suffix_**     | **2.2.0** | **1.10.1** |     **2.8.7**      |
...
```swift
dependencies: [
    .package(url: "https://github.com/rickclephas/KMP-ObservableViewModel.git", from: "1.0.0-BETA-12")
]
```
...
```ruby
pod 'KMPObservableViewModelSwiftUI', '1.0.0-BETA-12'
```
</p>
</details>
