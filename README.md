...
|---------------|-----------------|:---------:|:----------:|:------------------:|
| **_latest_**  | **_no suffix_** | **2.4.0** | **1.10.1** |     **2.8.7**      |
...
```swift
dependencies: [
    .package(url: "https://github.com/rickclephas/KMP-ObservableViewModel.git", from: "1.0.5")
]
```
...
```ruby
pod 'KMPObservableViewModelSwiftUI', git: 'https://github.com/rickclephas/KMP-ObservableViewModel.git', tag: 'v1.0.5'
```
</p>
</details>
